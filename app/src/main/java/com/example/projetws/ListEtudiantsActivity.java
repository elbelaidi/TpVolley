...
public class ListEtudiantsActivity extends AppCompatActivity implements EtudiantAdapter.OnItemClickListener {
    ...
    // Update these URLs
    private String fetchUrl = "http://192.168.1.34/MobileApp1/ws/loadEtudiant.php";
    private String updateUrl = "http://192.168.1.34/MobileApp1/ws/updateEtudiant.php";
    private String deleteUrl = "http://192.168.1.34/MobileApp1/ws/deleteEtudiant.php";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (etudiants != null && !etudiants.isEmpty()) {
                        ...
                        Log.d(TAG, "Students loaded successfully");
                    } else {
                        Log.d(TAG, "No students found in the response");
                        Toast.makeText(ListEtudiantsActivity.this,
                                "Aucun étudiant trouvé", Toast.LENGTH_SHORT).show();
                    }
                } catch (JsonSyntaxException e) {
                    Log.e(TAG, "JSON parsing error: " + e.getMessage());
                    Toast.makeText(ListEtudiantsActivity.this,
                            "Erreur de parsing des données", Toast.LENGTH_SHORT).show();
                }
            }
